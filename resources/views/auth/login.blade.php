...
<div class="page-login card-block mx-auto">
    <main>
        <div>
            <div class="bgwhite" id="main-wrapper">
                ...
                <div class="row">
                    <div class="col-md-3 center">
                        <div class="login-box">
                            ...
                            <p class="text-center m-t-xs text-sm"><?php echo date('Y') ?> &copy; CapitólioCamping.com.br</p>
                        </div>
                    </div>
                </div><!-- Row -->
            </div><!-- Main Wrapper -->
