...
class ProfilesController extends Controller
{
    ...
    {   
        ...
        if (Permissions::permissaoModerador($logged)) {
            ...
            $profiles = Profiles::where('c_auth', $logged->id)->orWhere('default', 1)->get();
        }
    ...
    {   
        ...
        if (Permissions::permissaoModerador($logged)) {
            ...
            $profiles = Profiles::where('c_auth', $logged->id)->orWhere('default', 1)->pluck('name', 'id');
        }
